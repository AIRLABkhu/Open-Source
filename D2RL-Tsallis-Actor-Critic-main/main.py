...
parser.add_argument('--q',type=float,default=1.2,metavar='G' ,help=' q-value of Tsallis Entropy (1.1 or 1.2 is highly recommended) (default:1.2)')
...
agent1=D2RL_TAC(env.observation_space.shape[0], env.action_space, args=args, q=args.q)
agent2=TAC(env.observation_space.shape[0], env.action_space, args=args, q=args.q)
...
memory_list=[mixed_memory1,mixed_memory2]
...
total_numstep_list=[total_numsteps1,total_numsteps2]
...
R_MAX_list=[R_MAX1,R_MAX2]

for i in range(2): # 알고리
    ...
    for iteration in range(1): # 훈련 반복
        ...
        for i_episode in itertools.count(1):
            ...
            if total_num>args.num_steps:
                break
#for csv
name_list=["D2RL_TAC q={}".format(args.q)," TAC q={}".format(args.q)]
csv_algo_list=list()
csv_inter_list=list()
