...
agent1=D2RL_DDPG(env.observation_space.shape[0], env.action_space, args=args)
agent2=DDPG(env.observation_space.shape[0], env.action_space, args=args)
